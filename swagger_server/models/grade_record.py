...
class GradeRecord(Model):
    ...
    def subject_name(self, subject_name: str):
        ...
        :type subject_name: str
        """
        #TESTDIEDif subject_name is None:
        #TESTDIED    raise ValueError("Invalid value for `subject_name`, must not be `None`")  # noqa: E501
    ...
    def grade(self, grade: float):
        ...
        :type grade: float
        """
       #TESTDIEDif grade is None:
        #TESTDIED    raise ValueError("Invalid value for `grade`, must not be `None`")  # noqa: E501
